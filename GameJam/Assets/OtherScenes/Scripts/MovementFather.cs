...
public class MovementFather : MonoBehaviour {
	...
	void Update (){
		...
		if (controller.isGrounded) {
			...
			moveDirection = new Vector3(Random.Range(-3, 4), 0, 0);  //get keyboard input to move in the horizontal direction
			//Gyroscope
		...
		controller.Move(moveDirection * Time.deltaTime *2);      //Move the controller
	}
}
